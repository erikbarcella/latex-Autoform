...
% ---
\titulo{AutoForm- Sistema para o Registro de Armas de Fogo no SIGMA via Arquivo Eletrônico em Lote (AEL) da Brigada Militar do RS }
\autor{Erik Barcella}
\local{Osório}
\data{2023}
\orientador{Bruno Chagas Fernandes}
\coorientador{Márcio Lemos} %COORIENTADOR. Deixar vazio se não houver.
\instituicao{%
...
% ---
\input{elementos-pre-textuais/folha-de-aprovacao}
% ---

% ---
% Dedicatória (Opcional)
% ---
\input{elementos-pre-textuais/dedicatoria}
% ---

% ---
% Agradecimentos (Opcional)
% ---
\input{elementos-pre-textuais/agradecimentos}
% ---

% ---
% Epígrafe (Opcional)
% ---
\input{elementos-pre-textuais/epigrafe}
...
\input{elementos-pre-textuais/resumo}

% resumo em inglês (Obrigatório)
\input{elementos-pre-textuais/abstract}
...
% Capitulo 1
% ---
\include{elementos-textuais/capitulo-1-referencial-teorico}
% ---
% ---
% Capitulo 2
% ---
\include{elementos-textuais/capitulo-2-trabalhos-relacionados}
% ---

% ---
% Capitulo 3
% ---
\include{elementos-textuais/capitulo-3-metodologia}
\include{elementos-textuais/capitulo-4-desenvolvimento}
% ---
...
\include{elementos-pos-textuais/anexos/anexo-a-1}
\include{elementos-pos-textuais/anexos/anexo-a-2}
\include{elementos-pos-textuais/anexos/anexo-a-3}
\include{elementos-pos-textuais/anexos/anexo-a-4}
\end{anexosenv}
